        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="hover:text-primary cursor-pointer">{t("aboutUsLink")}</li>
                <li className="hover:text-primary cursor-pointer">{t("contactLink")}</li>
                <li className="hover:text-primary cursor-pointer">{t("privacyPolicy")}</li>
                <li className="hover:text-primary cursor-pointer">{t("termsOfService")}</li>
              </ul>
            </div>
          ...
          <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 EasyConstruct. {t("allRightsReserved")}</p>
          </div>
        </div>
      </footer>
    </div>
