...
const translations = {
  en: {
    ...
    // Homepage
    heroTitle: "Build Your Dreams with Quality Materials",
    heroSubtitle:
  ...
  hi: {
    ...
    // Homepage
    heroTitle: "गुणवत्तापूर्ण सामग्री के साथ अपने सपनों का निर्माण करें",
    heroSubtitle:
  ...
  kn: {
    ...
    // Homepage
    heroTitle: "ಗುಣಮಟ್ಟದ ಸಾಮಗ್ರಿಗಳೊಂದಿಗೆ ನಿಮ್ಮ ಕನಸುಗಳನ್ನು ನಿರ್ಮಿಸಿ",
    heroSubtitle:
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const toggleLanguage = () =>
    setLanguageState((prev) => (prev === "en" ? "hi" : prev === "hi" ? "kn" : "en"))
